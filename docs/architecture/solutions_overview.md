# Solutions Architecture - Tax App Integration (Kra)

This document outlines how the Analytics Service is integrated for the Kra Tax App (Kenya Revenue Authority).
