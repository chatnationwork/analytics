...
The **Analytics Service** is a standalone, high-performance platform for collecting and visualizing user behavioral data. It is application-agnostic but currently integrated with:
- **Tax App** (MRI, TOT, NIL filing journeys)
