...
The Analytics Service is a high-performance system built for **Kra** (Kenya Revenue Authority). It collects, processes, stores, and visualises user behavioural data from web and WhatsApp channels. The system is deployed for Kra as the primary client; the data model uses a tenant for organisation and access control.
