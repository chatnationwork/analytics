...
export class AddAgentSessionsAndAssignedAt1769521500000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(
      `CREATE INDEX "IDX_agent_sessions_tenant_agent" ON "agent_sessions" ("tenantId", "agentId")`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_agent_sessions_tenant_started" ON "agent_sessions" ("tenantId", "startedAt")`,
    );
