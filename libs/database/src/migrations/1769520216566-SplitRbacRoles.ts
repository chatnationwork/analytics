...
export class SplitRbacRoles1769520216566 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."role_permissions_permission_enum" AS ENUM('analytics.view', 'analytics.export', 'settings.manage', 'users.manage', 'teams.manage', 'audit.view', 'team.settings', 'team.analytics', 'session.view', 'session.manage', 'agent.assign')`);
