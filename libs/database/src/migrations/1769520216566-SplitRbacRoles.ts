...
export class SplitRbacRoles1769520216566 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX IF EXISTS "public"."IDX_9c116ac03805ca80baf3e8d231"`);
        ...
        await queryRunner.query(`DROP TYPE IF EXISTS "public"."role_permissions_permission_enum_old"`);
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "IDX_9c116ac03805ca80baf3e8d231" ON "role_permissions" ("role", "permission")`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_9c116ac03805ca80baf3e8d231"`);
        await queryRunner.query(`CREATE TYPE "public"."role_permissions_permission_enum_old" AS ENUM('analytics.view', 'analytics.export', 'team.create', 'team.update', 'team.delete', 'team.manage_members', 'session.view', 'session.manage', 'session.assign', 'settings.manage')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_9c116ac03805ca80baf3e8d231" ON "role_permissions" ("permission", "role") `);
    }
