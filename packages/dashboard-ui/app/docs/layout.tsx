...
export default function DocsLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      {/* Header */}
      <header className="border-b border-white/10 bg-gray-900 sticky top-0 z-50">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className="w-64 border-r border-white/10 min-h-[calc(100vh-65px)] p-6 hidden lg:block sticky top-16">
