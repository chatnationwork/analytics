...
export default function JourneyPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-xl font-semibold text-white">User Journey</h1>
        <p className="text-sm text-gray-400 mt-0.5">Track complete user journeys across web and WhatsApp</p>
      </div>
        ...
        <div className="flex gap-3">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-gray-800 border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          <button
      ...
      {!selectedUser && (
        <div className="bg-gray-800/50 rounded-xl border border-white/10 p-12 text-center">
          ...
          <h2 className="text-lg font-medium text-white mb-2">Search for a User</h2>
        ...
        <div className="bg-gray-800/50 rounded-xl border border-white/10 p-6">
          ...
          <div className="flex items-start gap-4 mb-6 pb-6 border-b border-white/10">
            ...
            <div className="flex-1">
              <div className="font-semibold text-lg text-white">{selectedUser.name}</div>
            ...
            <div className="text-right text-sm">
              ...
              <div className="text-white font-medium">{selectedUser.firstSeen}</div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-4 mb-6 pb-6 border-b border-white/10">
            <div className="text-center">
              <div className="text-2xl font-bold text-white">{selectedUser.totalSessions}</div>
              <div className="text-xs text-gray-400">Sessions</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-white">{selectedUser.totalEvents}</div>
              <div className="text-xs text-gray-400">Events</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-white">{selectedUser.lastSeen}</div>
                  ...
                  <div className="flex-1 pb-4">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className={`text-xs px-2 py-0.5 rounded ${
                        event.type === 'whatsapp' ? 'bg-green-500/20 text-green-400' : 'bg-blue-500/20 text-blue-400'
                      }`}>
                        {event.type}
                      </span>
                    </div>
